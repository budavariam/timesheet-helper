...
export function manipulateData(project: ProjectData, weekLength: number, rounding: number, adjustments: Map<string, number>, ignoreProjects: Set<string>, autoIgnore: Set<string>, projectOrder: string[] = []): ProjectData {
    ...
    project.projects.forEach((project) => {
        const shouldIgnore = ignoreProjects.has(project.uuid) || autoIgnore.has(project.client)
        const proj = {
            ...project,
            ignore: shouldIgnore,
